module OneDHeatTransfer
        ...
        struct HeatTransferProblem{D, CF,LF,LDF,ITF, G, BCU, BCD,TMATtype, CacheType} # D is for temperature data type
            ...
            function HeatTransferProblem(C_fun, L_fun, Ld_fun, initT_fun,
             ...
             """
    HeatTransferProblem(C_fun::CF, L_fun::LF, Ld_fun::LDF, initT_fun,
                                        H::D, N::Int,
                                        tmax::D, M::Int,
                                        bc_fun_up, upper_bc_type::AbstractBoundaryCondition,
                                        bc_fun_dwn, lower_bc_type::AbstractBoundaryCondition,
...
This version of constructor accepts physical properties provided externally , without creating the new objects
Thus is can be used to create several problems with the same physical properties 
"""
function HeatTransferProblem(C_f::CF, L_f::LF, Ld_f::LDF, initT_fun,
                                        H::D, N::Int,
                                        tmax::D, M::Int,
                                        bc_fun_up, upper_bc_type::AbstractBoundaryCondition,
                                        bc_fun_dwn, lower_bc_type::AbstractBoundaryCondition,
                                        ::Type{DT}) where {CF<:PhysicalPropertyFunction,
                                                           LF<:PhysicalPropertyFunction,
                                                           LDF<: PhysicalPropertyFunction,
                                                           D, DT <:Number}
