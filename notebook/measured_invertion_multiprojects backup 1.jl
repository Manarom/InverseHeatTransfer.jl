...
# ╔═╡ 9eceb9be-4f99-43a0-ae5f-cc32bd7c0fb4
md" Regularization multiplier α: $(@bind reg_multiplier confirm(NumberField(0.0 : 1e-3 : 1000 , default = 1e-3))) "
...
md" Direct problem number of time steps $(@bind dp_tpoints Select(10:10:2000, default = 2000))"
...
IHT.loss_distribution_matrix(parallel_probls)
...
git-tree-sha1 = "025180ce2163cdd71ba6e5a227bd06cf203b559c"
