...
using Plots, Revise, OrderedCollections, PlutoUI, DataFrames, StatsPlots, CSV
...
$(@bind selected_variables confirm(MultiSelect(collect(keys(selected_proj.data))))) 
...
md" Save to folder: $(@bind folder_name TextField(default = @__DIR__))"

# ╔═╡ 4f65ae20-46b2-42e5-a6ff-9fc3644a1866
md""" File name: $(@bind file_name TextField(default = "measured.csv"))"""
...
manifest_format = "2.0"
project_hash = "cadd51079e1fdd0485cecb084262c5109cb59dce"
...
git-tree-sha1 = "be315b2e9d04dc1c354aed78116b5a8b73192995"
